  ...
  return (
    ...
    <div className='main'>
      <div className="mainleft cont">
        ...
        <button onClick={destination}>Get Started →</button>
        </div>
      </div>
      <div className="mainright cont">
         <div className="mainrightcont">
          <div className="maincube1 maincube">

          </div>
          <div className="maincube2 maincube">

          </div>
           <div className="main-box1 main-box">

           </div>
           <div className="main-box2 main-box">
